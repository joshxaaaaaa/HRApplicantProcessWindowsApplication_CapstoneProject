...
CREATE TABLE `applicantdocuments` (
  ...
  CONSTRAINT `applicantdocuments_ibfk_1` FOREIGN KEY (`application_id`) REFERENCES `applications` (`application_id`) ON DELETE CASCADE,
  CONSTRAINT `applicantdocuments_ibfk_2` FOREIGN KEY (`requirement_type_id`) REFERENCES `requirementtypes` (`requirement_type_id`) ON DELETE RESTRICT
