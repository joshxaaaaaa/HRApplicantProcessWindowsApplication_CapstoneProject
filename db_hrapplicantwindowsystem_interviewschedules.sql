...
CREATE TABLE `interviewschedules` (
  ...
  CONSTRAINT `interviewschedules_ibfk_1` FOREIGN KEY (`application_id`) REFERENCES `applications` (`application_id`) ON DELETE CASCADE,
  CONSTRAINT `interviewschedules_ibfk_2` FOREIGN KEY (`interviewer_id`) REFERENCES `users` (`user_id`) ON DELETE RESTRICT
