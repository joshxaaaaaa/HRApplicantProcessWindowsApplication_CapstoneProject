...
CREATE TABLE `applicationstatushistory` (
  ...
  CONSTRAINT `applicationstatushistory_ibfk_1` FOREIGN KEY (`application_id`) REFERENCES `applications` (`application_id`) ON DELETE CASCADE,
  CONSTRAINT `applicationstatushistory_ibfk_2` FOREIGN KEY (`changed_by`) REFERENCES `users` (`user_id`) ON DELETE SET NULL
